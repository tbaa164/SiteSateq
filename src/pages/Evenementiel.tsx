...
const Evenementiel = () => {
  useEffect(() => {
    document.title = "Evénementiel - SATEQ Digital Group";
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-r from-orange-600 via-orange-500 to-green-600">
          <div 
              ...
              <div className="max-w-3xl">
                ...
                >
                  ...
                  <p className="text-lg md:text-xl text-white/90 leading-relaxed">
                    Organisation et gestion d'événements professionnels et corporate
                  </p>
                </motion.div>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Cette page présentera prochainement nos services d'organisation d'événements professionnels, 
                  séminaires, conventions, lancements de produits et autres manifestations corporate.
                </p>
              </motion.div>
            </div>
          </div>
