...
const Cartes = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[21vh] md:h-[27vh] overflow-hidden bg-gradient-to-r from-emerald-800 via-green-700 to-orange-600">
        ...
        <div className="animate-fade-in max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-all duration-300">
              <div className="space-y-4">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <h2 className="text-xl font-bold text-gray-800">Types de cartes</h2>
                </div>
                
                <div className="space-y-3">
                  {["Carte d'identification", "Carte privative QR-Code multifonction", "Carte bancaire"].map((item, index) => (
                    <div key={index} className="flex items-start px-3 py-2 bg-gray-50 rounded-lg transition-all hover:bg-gray-100">
                      <svg className="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="mt-6">
                  <div className="bg-gradient-to-r from-green-50 to-emerald-100 rounded-xl p-4 border-l-4 border-green-500">
                    <p className="font-medium text-emerald-800">
                      Avec ses partenaires, <span className="font-bold">SATEQ DIGITAL</span> propose des cartes sécurisées intégrant des puces pour répondre aux besoins spécifiques.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 mt-8 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center space-x-2 mb-6">
              <div className="h-8 w-2 bg-gradient-to-b from-orange-500 to-amber-600 rounded-full"></div>
              <h2 className="text-xl font-bold text-gray-800">Caractéristiques disponibles</h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={index} className="flex items-start px-3 py-2 bg-gray-50 rounded-lg transition-all hover:bg-gray-100">
                  <svg className="w-5 h-5 text-orange-500 mt-0.5 mr-3 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
          ...
          <div className="max-w-7xl mx-auto mt-8">
            <div className="bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl p-6">
              <h3 className="text-xl md:text-2xl font-bold text-center mb-6">Nos exemples de cartes</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={index} className="overflow-hidden hover:shadow-lg transition-all duration-300 animate-scale-in bg-white rounded-xl" style={{ animationDelay: `${index * 0.2}s` }}>
                    <div className={`h-2 bg-gradient-to-r ${carte.color}`}></div>
                    <div className="p-4">
                      ...
                      <h4 className={`text-lg font-semibold mb-2 ${carte.textColor}`}>{carte.alt}</h4>
                      <ul className="space-y-2 text-sm text-gray-600">
                        {carte.features.map((feature, idx) => (
                          <li key={idx} className="flex items-center">
                            <span className={`w-1.5 h-1.5 rounded-full bg-${carte.color.split(' ')[0].replace('from-', '')} mr-2`}></span>
                            <span>{feature}</span>
                          </li>
                        ))}
                      </ul>
