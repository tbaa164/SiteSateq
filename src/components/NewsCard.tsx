  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <div className="relative">
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-semibold text-gray-800 mb-1 leading-snug line-clamp-2">{item.title}</h4>
        ...
        <div className="absolute right-2 top-1/2 -translate-y-1/2 h-20 w-1 flex items-center">
