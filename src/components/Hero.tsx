  ...
  return (
    <div className="relative">
      <div className="min-h-screen bg-background">
        {/* Hero Section */}
        <section className="relative h-72 sm:h-64 lg:h-79 overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            />
            {/* Overlay léger pour meilleure lisibilité du texte sans trop masquer l'image */}
            <div className="absolute inset-0 bg-gradient-to-r from-primary/30 via-transparent to-black/30 mix-blend-multiply"></div>
          </div>
          
          {/* Fond sombre pour contraste - très léger */}
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 h-full w-full lg:w-2/3 flex items-center justify-end pr-8">
          <div className="relative group animate-float">
            {/* Effet de lueur et dégradé en arrière-plan */}
            <div className="absolute inset-0 bg-gradient-to-tr from-primary/30 via-accent/40 to-orange-400/30 rounded-xl blur-xl transform scale-110 animate-pulse"></div>
            <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 via-accent/0 to-orange-500/20 rounded-xl blur-md transform scale-105 animate-gradient-x"></div>
            ...
            {/* Éléments décoratifs */}
            <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-accent/20 rounded-full blur-md -z-10 animate-pulse" style={{ animationDelay: '0.5s' }}></div>
            <div className="absolute -top-4 -left-4 w-16 h-16 bg-primary/20 rounded-full blur-md -z-10 animate-pulse" style={{ animationDelay: '1.2s' }}></div>
        ...
        <div className="relative container mx-auto px-6 h-full flex flex-col justify-center text-white">
          {/* Cercles décoratifs près du texte - Ajustés pour être plus visibles */}
          <div className="absolute left-4 top-0 w-10 h-10 bg-accent rounded-full blur-sm animate-orbit-fast animate-pulse z-20" style={{ animationDelay: '0s' }}></div>
          <div className="absolute left-20 bottom-0 w-8 h-8 bg-primary rounded-full blur-sm animate-orbit-fast animate-pulse z-20" style={{ animationDelay: '1s' }}></div>
          <div className="absolute left-40 top-1/3 w-6 h-6 bg-orange-400 rounded-full blur-sm animate-orbit-fast animate-pulse z-20" style={{ animationDelay: '0.5s' }}></div>
          
          <h1 className="text-4xl md:text-4xl font-bold mb-4 drop-shadow-lg mt-8 sm:mt-0 pt-4 sm:pt-0">
            <span className="inline-block">LES</span> TECHNOLOGIES DIGITALES
          </h1>
          <h2 className="text-4xl md:text-4xl font-bold mb-6 drop-shadow-lg">
            AU SERVICE DE L'ÉCONOMIE NUMÉRIQUE EN AFRIQUE
          </h2>
          <div className="space-y-3 text-2xl drop-shadow-md">
            <p>RÉSEAUX, IDENTITÉ & PAIEMENT ÉLECTRONIQUE</p>
      ...
      {/* Enhanced Description Section with improved design - Full Width Layout */}
      <section className="bg-gradient-to-b from-white to-gray-50 py-4 mt-4">
